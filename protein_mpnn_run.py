...
def main(args):
    ...
    if args.path_to_model_weights:
        ...
        if args.ca_only:
            ...
            model_folder_path = os.path.join(current_dir, 'ca_model_weights')
            ...
            if args.use_soluble_model:
                ...
                model_folder_path = os.path.join(current_dir, 'soluble_model_weights')
            else:
                model_folder_path = os.path.join(current_dir, 'vanilla_model_weights')
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--pdb_path_chains", type=str, default='',
                           help="Specify comma-separated chains to design (e.g. 'A,B')")
